...
selected_model = st.selectbox("Sélectionnez le modèle entrainé :", options= ["Random Forest", "XGBoost"])
...
if df_filtered.empty:
    ...
    for region in choix_liste:
        ...
        #model_path = f"../models_predict/{model_name}"
        #model_path = os.path.join("models_predict", model_name)
        BASE_DIR = os.path.dirname(os.path.abspath(__file__))       # /mount/src/pages/
        ROOT_DIR = os.path.abspath(os.path.join(BASE_DIR, ".."))    # /mount/src/
